...
static constexpr bool ESP_NOW_LONG_RANGE = false;

static constexpr uint8_t RECEIVER_MAC[MAC_ADDRESS_LENGTH] = {0x1C, 0xDB, 0xD4, 0x9D, 0x8D, 0xE0};

static constexpr uint8_t TRANSMITTER_MAC[MAC_ADDRESS_LENGTH] = {0xE0, 0x72, 0xA1, 0xD2, 0x42, 0xF4};
